...
------------ ANSWER -------------------
 ...
 log var x would print out "I'm a local variable" because var x is globe and can be passed through.

 log var y would print out undefined  because var y is declared in iife and cant be used out of it.
...
log var x wouldnt log because it being logged before its declared!
...
the one inside IIfe is going to add the integer but the one outside isnt.
